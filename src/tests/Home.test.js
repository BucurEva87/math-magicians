...
describe('Home component', () => {
  ...
  test('renders h1 element containing the title', () => {
    expect(getByTestId('home-h1')).toHaveTextContent('Welcome to our page!');
  });
  test('renders first paragraph element containing a text', () => {
    expect(getByTestId('home-p-first')).not.toHaveTextContent('');
  });
  test('renders second paragraph element containing a text', () => {
